...
const CustomSwitch = ({ className = '', ...props }: CustomSwitchProps): JSX.Element => (
    <div className={cn('relative h-5 w-10', className)}>
        ...
        <span
            className={cn(
                'peer-checked:bg-blue-500 block h-full rounded-full bg-gray-200 before:absolute before:bottom-1 before:left-1 before:h-3 before:w-3 before:rounded-full before:bg-white before:transition-all before:duration-300 peer-checked:before:left-6 dark:bg-gray-700 dark:peer-checked:before:bg-white',
